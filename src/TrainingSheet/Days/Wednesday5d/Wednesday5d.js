...
const Wednesday5d = (props) => {
  ...
  const inclineBenchProgression = [
    props.benchTrainingMax * 0.4 + "kg x6",
    props.benchTrainingMax * 0.5 + "kg x5",
    props.benchTrainingMax * 0.6 + "kg x3",
    props.benchTrainingMax * 0.6 + "kg x5",
    props.benchTrainingMax * 0.6 + "kg x7",
    props.benchTrainingMax * 0.6 + "kg x4",
    props.benchTrainingMax * 0.6 + "kg x6",
    props.benchTrainingMax * 0.6 + "kg x8",
    " ",
  ];
